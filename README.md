...
const ayush = {
    ...
    currentFocus: ["Full Stack Development", "AI/ML", "Computer Vision"],
...
### 🍕 Food Delivery App
**MERN Stack | Stripe Integration**

A full-featured food delivery platform with:
...
Working on exciting new projects in:
- 🌐 Web3 & Blockchain
- 🤖 Advanced AI/ML
- 📱 Mobile Development
...
|:---:|:---:|:---:|
| 🛰️ ISRO Experiential Learning | Sep 2024 | ISRO-NRSC Hyderabad |
| 📡 BSNL Experiential Learning | Sep 2024 | BSNL Hyderabad |
| 💡 Ideathon Winner | Dec 2022 | AI Club, VIT Bhopal |
| 🐍 Python Essentials | 2024 | VITyarthi |
...
goals_2025 = {
    ...
    "professional": [
        "Secure SDE Internship at Top Tech Company",
        "Improve CGPA to 8.0+",
...
**Thank you for visiting! Don't forget to ⭐ my repositories if you find them interesting!**
